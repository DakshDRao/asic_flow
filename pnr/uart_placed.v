module UART (clk,
 ...
 sky130_fd_sc_hd__dfxtp_1 _241_ (.CLK(clk),
    .D(_001_),
    .Q(current_byte[1]));
 sky130_fd_sc_hd__dfxtp_1 _242_ (.CLK(clk),
    .D(_002_),
    .Q(current_byte[2]));
 sky130_fd_sc_hd__dfxtp_1 _243_ (.CLK(clk),
    .D(_003_),
    .Q(current_byte[3]));
 sky130_fd_sc_hd__dfxtp_1 _244_ (.CLK(clk),
    .D(_004_),
    .Q(current_byte[4]));
 sky130_fd_sc_hd__dfxtp_1 _245_ (.CLK(clk),
    .D(_005_),
    .Q(current_byte[5]));
 sky130_fd_sc_hd__dfxtp_1 _246_ (.CLK(clk),
    .D(_006_),
    .Q(current_byte[6]));
 sky130_fd_sc_hd__dfxtp_1 _247_ (.CLK(clk),
    .D(_007_),
    .Q(current_byte[7]));
 sky130_fd_sc_hd__dfxtp_1 _248_ (.CLK(clk),
    .D(_008_),
    .Q(tx));
 sky130_fd_sc_hd__dfxtp_1 _249_ (.CLK(clk),
    .D(_009_),
    .Q(read_en));
 sky130_fd_sc_hd__dfxtp_1 _250_ (.CLK(clk),
    .D(_010_),
    .Q(counter[0]));
 sky130_fd_sc_hd__dfxtp_1 _251_ (.CLK(clk),
    .D(_011_),
    .Q(counter[1]));
 sky130_fd_sc_hd__dfxtp_1 _252_ (.CLK(clk),
    .D(_012_),
    .Q(counter[2]));
 sky130_fd_sc_hd__dfxtp_1 _253_ (.CLK(clk),
    .D(_013_),
    .Q(counter[3]));
 sky130_fd_sc_hd__dfxtp_1 _254_ (.CLK(clk),
    .D(_014_),
    .Q(counter[4]));
 sky130_fd_sc_hd__dfxtp_1 _255_ (.CLK(clk),
    .D(_015_),
    .Q(counter[5]));
 sky130_fd_sc_hd__dfxtp_1 _256_ (.CLK(clk),
    .D(_016_),
    .Q(counter[6]));
 sky130_fd_sc_hd__dfxtp_1 _257_ (.CLK(clk),
    .D(_017_),
    .Q(counter[7]));
 sky130_fd_sc_hd__dfxtp_1 _258_ (.CLK(clk),
    .D(_018_),
    .Q(counter[8]));
 sky130_fd_sc_hd__dfxtp_1 _259_ (.CLK(clk),
    .D(_019_),
    .Q(counter[9]));
